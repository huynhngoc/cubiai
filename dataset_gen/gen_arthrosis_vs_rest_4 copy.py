...
h5_filename = '//nmbu.no/Research/Project/CubiAI/preprocess/datasets/800_lvl1_vs_rest.h5'
rs=27
...
for d in range(7):
    if d+1 == 6: 
        ...
        new = ds[ds['diagnosis']==d+1].sample(frac=0.5, random_state=rs, axis = 0, replace=False)
