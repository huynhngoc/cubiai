...
#SBATCH --mail-user=$artush.mkrtchyan@nmbu.no # Email me when job is done.
...
singularity exec --nv deoxys-efficient.sif python experiment_multiclass_linear.py $1 $PROJECTS/ngoc/CubiAI/perf/pretrain/$2 --temp_folder $SCRATCH_PROJECTS/ceheads/CubiAI/pretrain/$2 --epochs $3 ${@:4}
